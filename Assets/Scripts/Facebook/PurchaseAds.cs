...
public class PurchaseAds : MonoBehaviour, IStoreListener
{
	...
	private static string kProductNameAppleNonConsumable = "superkongsaga.removeads";      // Apple App Store identifier for the non-consumable product.

	private static string kProductNameGooglePlayNonConsumable = "superkongsaga.removeads";     // Google Play Store identifier for the non-consumable product.
	...
	public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
	{
		...
		{
			PlayerPrefs.SetString ("removeadsKong", "yes");
			Destroy (gameObject);
