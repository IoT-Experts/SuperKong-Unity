...
public class Water : MonoBehaviour {
   ...
   // public float Left = -10.0f;
    public float Widlth = 20.0f;
   // public float Top = 0;
    public float Bottom = -3.0f;
    ...
    public void SpawnWater(float Width, float Bottom)
    {
        ...
        gameObject.GetComponent<BoxCollider2D>().offset = new Vector2(Width / 2, (Bottom) / 2);
        gameObject.GetComponent<BoxCollider2D>().size = new Vector2(Width, - Bottom);
        ...
        Body.material = lightMat;
      //  Body.material.renderQueue = 1000;
        Body.SetVertexCount(nodecount);
        Body.SetWidth(0.06f, 0.06f);
        Body.SetColors(Color.white, Color.white);
